...
public class LoteController {
    ...
    public String mostrarFormularioCrear(Model model) {
        Long idSede = obtenerIdSedeTemporal();
        List<com.proyecto.core.medicamento.application.dto.MedicamentoResponseDTO> medicamentos = medicamentoService.listarMedicamentosPorSede(idSede);
    ...
    public String listarLotesPorMedicamento(@PathVariable Long idMedicamento, Model model) {
        try {
            ...
            com.proyecto.core.medicamento.application.dto.MedicamentoResponseDTO medicamento = medicamentoService.obtenerMedicamentoPorId(idMedicamento);
